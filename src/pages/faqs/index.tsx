...
const FaqPage = ({ ...data }) => {
  ...
  data?.data.forEach((e: { attributes: { question: string; answer: string; }; }) => {
    const entity = {
      "@type": "Question",
  ...
  const description = "use the the faqs to to get more information about the company and services."
