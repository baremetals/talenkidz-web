...
const EventEditForm = (props: { data: { events: EventEntityResponseCollection; }; loading: boolean; error: any; }) => {
    useIsAuth();
    ...
    return (
        ...
        >
            ...
            <EditForm id={eve?.id as string} attributes={eve?.attributes as Maybe<Event>} formType='events' />
        </Layout>
    )
}
