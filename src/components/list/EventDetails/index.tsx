      ...
      <InnerContainer style={{ maxWidth: '1024px' }}>
           ...
           <EventBanner src={'/assets/images/image 92.png'} />
            ...
            <Column className="column-7">
              <PageTitle className="pageTitle" text={["Discover watercolor landscapes! Painting for kids from 6-9 years", <span key={"workshops"}>workshops</span>,]} />
        ...
        <AboutEvent>
          <h2>About event </h2>
          <p>In a sea of you can let off steam here with lots of fun and joy, because there are no limits to your creativity.
          </p>
          <h3> Course content:</h3>
          <p>This watercolor course is about the endless expanses and the beauty of landscapes. Whether meadows, fields, flowers, trees, houses, bridges, walls and Co.: There is a lot to discover! What should your landscape look like?
          In this workshop, Stefanie Driver invites you to paint your own colorful landscape and get to know the magic of watercolor paints at the same time.?</p>
          <p>No previous knowledge is required, a good mood and anticipation are enough! Painting is based on watercolours, water-soluble wooden pencils and various fineliners.</p>
         <h3>Prerequisite:</h3>
          ...
          <p>
            My name is Stefanie Driver, I am 42 years old, I live with my husband and my 2 children (6 and 11 years) and our little Havanese dog in Karlsruhe/Oberreut. It feels like I have been creative my whole life and I need colors around me. I started painting with acrylics more than 21 years ago and from then on I tried quite a few things, developed myself further and also took part in specific painting courses. Acrylic/watercolor/pencil/pastel chalk, perspectives/shadows/representational, up to zentangle and HappyPainting have filled my schedule. I am already working as a lecturer at the vhs Rastatt and am currently offering various painting courses. I am constantly developing myself part-time around the topic of painting and drawing in order to keep creating new course content and trying out new painting materials.</p>
            <h3>Important information about participation in our events:</h3>
 <p>Age: 6 to 9 years | Maximum number of participants: 10 | For the safety of each and every course participant, we ask you to observe the current Corona Ordinance of the State of Baden-Württemberg with every visit. The disinfectant exhibited on the workshop area should and may be used plentifully. If you have any further questions regarding the measures currently in force & our courses, please write to us at any time at: veranstaltungen@papierfischer.de</p>
        </AboutEvent>
        ...
        {/*event*/}
            <EventList>
            <Row >
              <Column><PageTitle className="pageTitle" text={["Most",<span key={"workshops"}>popular</span>,"events"]} /></Column>
            </Row>
            <Row>
              <Column>
                <EventItem />
